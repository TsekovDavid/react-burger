...
export const REGISTER_ENDPOINT = `${BURGER_API_URL}/auth/register`;
export const LOGIN_ENDPOINT = `${BURGER_API_URL}/auth/login`;
export const TOKEN_ENDPOINT = `${BURGER_API_URL}/auth/token`;
export const LOGOUT_ENDPOINT = `${BURGER_API_URL}/auth/logout`;
...
export const RESET_PASSWORD_ACCESS_KEY = 'resetPasswordAllowed';
